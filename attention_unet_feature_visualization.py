...
Applies optimization-based visualization to Attention U-Net architecture to understand:
- What patterns activate specific channels
- How attention gates modulate feature representations
- Differences between standard U-Net and attention-augmented version
...
class ConvBlock(nn.Module):
    """Standard convolution block with Batch Normalization"""
...
class FeatureVisualizer:
    """
    Optimization-based feature visualization for Attention U-Net
    ...
    def visualize_channel(
        ...
        Args:
            layer_name: Name of layer to visualize (e.g., 'decoder_1_conv2', 'attention_gate_3')
...
def main():
    parser = argparse.ArgumentParser(
        description='Feature Visualization for Attention U-Net'
    )
    parser.add_argument('--model_path', type=str,
                       default='./best_models_PyTorch/attention_unet/best_model.pth')
    parser.add_argument('--output_dir', type=str,
                       default='./attention_unet_feature_viz')
    ...
    parser.add_argument('--layers', type=str, nargs='+',
                       default=['encoder_1_conv2', 'encoder_3_conv2',
                               'bottleneck_conv2', 'attention_gate_3',
                               'decoder_1_conv2'],
    ...
    print(f"\n{'='*70}")
    print(f"Attention U-Net Feature Visualization")
    print(f"{'='*70}")
    ...
    model = AttentionUNet(in_channels=1, n_filters=args.n_filters, dropout=args.dropout)
    ...
    print(f"\nKey feature: Includes attention gate visualizations!")
    print(f"  - Compare attention-modulated vs non-modulated features")
    print(f"  - See what patterns attention gates focus on")
