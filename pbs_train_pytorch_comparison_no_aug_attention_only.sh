...
#PBS -j oe
#PBS -k oed
#PBS -N PyTorch_NoAug_AttentionOnly
#PBS -l select=1:ncpus=36:mpiprocs=1:ompthreads=36:ngpus=1:mem=240gb
#PBS -M phyzxi@nus.edu.sg
#PBS -m abe

# ==============================================================================
# PyTorch Training: Attention Architectures Only (No Augmentation)
# ==============================================================================
#
...
echo "Augmentation: NONE"
echo "Skipping: UNet (already trained)"
echo "========================================"
echo ""

# Create a wrapper script to modify CONFIG and run training
cat > run_attention_only_no_aug.py << 'WRAPPER_EOF'
import sys
import train_pytorch_comparison_no_aug as training_script
...
singularity exec --nv $image python run_attention_only_no_aug.py

# Capture exit status
EXIT_STATUS=$?

# Clean up wrapper script
rm -f run_attention_only_no_aug.py
