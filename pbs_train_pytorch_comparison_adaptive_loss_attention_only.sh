...
#PBS -j oe
#PBS -k oed
#PBS -N PyTorch_AdaptiveLoss_AttentionOnly
#PBS -l select=1:ncpus=36:mpiprocs=1:ompthreads=36:ngpus=1:mem=240gb
#PBS -M phyzxi@nus.edu.sg
#PBS -m abe

# ==============================================================================
# PyTorch Training: Attention Architectures Only (AdaptiveBGDiceLoss)
# ==============================================================================
#
...
# - AdaptiveBGDiceLoss (focal + TV + Tversky + bg-adaptive)
...
cat > run_attention_only_adaptive_loss.py << 'WRAPPER_EOF'
import sys
import train_pytorch_comparison_adaptive_loss as training_script
...
singularity exec --nv $image python run_attention_only_adaptive_loss.py

# Capture exit status
EXIT_STATUS=$?

# Clean up wrapper script
rm -f run_attention_only_adaptive_loss.py
