#!/usr/bin/bash
#PBS -N EdgeDet_Viz_Frozen
#PBS -l walltime=4:00:00
#PBS -l select=1:ncpus=8:mpiprocs=1:ompthreads=8:ngpus=1:mem=32gb
#PBS -j oe
#PBS -P personal-phyzxi
#PBS -o EdgeDet_Viz_Frozen.o
#PBS -q normal

################################################################################
# Advanced Visualization for Frozen Gabor Edge Detector Model
#
# This script generates comprehensive visualizations for the frozen layer 1
...
#   - Layer 1 Gabor filter comparison (initial vs final - should be identical!)
#
...
# Configuration
MODEL_PATH="./edge_detector_experiment/20251030_122713/unet_frozen_layer1/best_model.pth"
INITIAL_WEIGHTS="./edge_detector_experiment/20251030_122713/unet_frozen_layer1/layer1_weights_epoch000.pth"
TEST_IMAGES_DIR="./test_images"
OUTPUT_DIR="./edge_detector_viz_advanced_frozen_layer1"
...
echo "Configuration:"
echo "  Variant: Frozen Layer 1 (Gabor filters stay fixed)"
...
echo "  ✓ Layer 1 Gabor comparison (initial = final, should be identical!)"
echo ""
...
echo ""
echo "2. Compare with trainable layer 1:"
echo "   diff -r $OUTPUT_DIR edge_detector_viz_advanced_trainable_layer1/"
echo ""
echo "3. Check if Layer 1 stayed frozen:"
echo "   cat $OUTPUT_DIR/*/layer1_comparison/layer1_metrics.json"
echo "   # cosine_similarity should = 1.0, weights_identical should = true"
echo ""
echo "4. Compare with baseline U-Net:"
echo "   # Compare feature inversions to see if Gabor filters produce different patterns"
