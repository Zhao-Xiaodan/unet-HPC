...
# Run training
echo "========================================"
echo "Starting PyTorch Training (No Augmentation)"
echo "Training 3 architectures × 27 configs = 81 models"
echo "========================================"
echo ""

singularity exec --nv $image python train_pytorch_comparison_no_aug.py
